...
function exp_PotentialLocation_1rule0_eval_expression(context) {
    // SYMBOL = 'SP' AND NAME LIKE 'Long%'

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('SYMBOL')  == 'SP') && (feature.get('NAME').indexOf('Long') > -1));
    } else {
        return ((feature.get('SYMBOL')  == 'SP') && (feature.get('NAME').indexOf('Long') > -1));
    }
}
...
function exp_PotentialLocation_1rule1_eval_expression(context) {
    // SYMBOL = 'CC'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('SYMBOL')  == 'CC');
    } else {
        return (feature.get('SYMBOL')  == 'CC');
    }
}
...
function exp_PotentialLocation_1rule2_eval_expression(context) {
    // SYMBOL = 'LB' AND NAME NOT LIKE 'Aurora%' AND NAME NOT LIKE 'Glen%'

    var feature = context.feature;
    
    if (feature.properties) {
        return (((feature.get('SYMBOL')  == 'LB') && (feature.get('NAME').indexOf('Aurora') == -1)) && (feature.get('NAME').indexOf('Glen') == -1));
    } else {
        return (((feature.get('SYMBOL')  == 'LB') && (feature.get('NAME').indexOf('Aurora') == -1)) && (feature.get('NAME').indexOf('Glen') == -1));
    }
}